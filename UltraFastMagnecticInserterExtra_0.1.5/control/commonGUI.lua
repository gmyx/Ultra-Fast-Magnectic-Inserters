...
function commonGUI:openGUI(entity, player_index)
	...
	flow3.add{type="textfield", numeric="true", name="CI_override_value", text=getStackOverrideCurrentValue(entity,player_index), enabled=(entity.inserter_stack_size_override > 0)}
	flow3["CI_override_value"].style = "very_short_number_textfield"
	flow3["CI_override_value"].style.width=40
